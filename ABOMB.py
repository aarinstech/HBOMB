...
def ascii():
    print(white+     r"     ___________________                                                              ")
    print(grey+      r"    /                   \                                                             ")
    print(purple+    r"   / /             \\     \                                                           ")
    print(red+       r"  |                      |                                                            ")
    print(green+     r"  /        \   \ |  | /  /                                                            ")
    print(yellow+    r" |        |    __       |                                                             ")
    print(cyan+      r" |        |      \      |                                                             ")
    print(cafe+      r" |        |       \     |        ___________________________________________________  ")
    print(color+     r"/         |     ___     |       | Hello, I'm Your Bombing Friend,                   | ")
    print(blue+      r"|         |    ( __O)   |       | And Gonna Help You To Perform SMS/Call Bombing.   | ")
    print(white+     r"|         |              \      | But Before That Please Follow And Subscribe,      | ")
    print(grey+      r"|         |               \     | To The person's Accounts Who Made Me. Links Below.| ")
    print(purple+    r"|      ___\           (*___\    |___________________________________________________| ")
    print(red+       r" \    ||          _     |      /                                                      ")
    print(green+     r"  |   |___     //_______|     /                                                       ")
    print(yellow+    r"  |   |          |_|_|_|__/\                                                          ")
    print(cyan+      r"  |   |         \ -        |                                                          ")
    print(cafe+      r"  |   |       _----________/                                                          ")
    print(color+     r"   \ /       /                                                                        ")
    print(blue+      r"    |       /                                                                         ")
    print(white+      "    |      /                                                                        \n")
